    ...
    private static final Callback sRoomDatabaseCallback = new Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            databaseWriteExecutor.execute(() -> {
                ...
                //Dummy Trip
                Trip.StartGeo startGeo = new Trip.StartGeo(59.948376, 11.007322, 20);
                Trip.StopGeo stopGeo = new Trip.StopGeo(11.007322, 59.943497, 350);
                Trip trip =  new Trip(1,"Home", "Job", 0.5, 10, 50, 20,50, startGeo, stopGeo, false, 450);
                trip.mIsFinished = false;
